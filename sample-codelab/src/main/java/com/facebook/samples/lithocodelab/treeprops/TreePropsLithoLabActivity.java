 ...
 */
public class TreePropsLithoLabActivity extends AppCompatActivity {
  ...
  public class LabExampleController {
    ...
    private final Component<Foo> fooComponent;
    ...
    public void goToMain() {
      setContentComponent(fooComponent);
      isMain = true;
    }

    public void setContentComponent(Component component) {
      isMain = false;
      TreePropsLithoLabActivity.this.setContentView(
          LithoView.create(TreePropsLithoLabActivity.this /* context */, component));
    }
  }
}
